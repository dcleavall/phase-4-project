...
const Home = () => {
  ...
  return (
    <div className="home">
      ...
      <h1 className="text-3xl font-bold mb-4 text-center">Live a Healthier and gain Rewards!</h1>
        {user !== null ? (
          <>
            ...
            <div className="health-choice-buttons flex justify-center mb-4">
              <button
                ...
                } rounded-lg py-2 px-4 mr-2 bg-blue-500 text-white hover:bg-blue-600`}
              ...
              <button
                ...
                } rounded-lg py-2 px-4 bg-blue-500 text-white hover:bg-blue-600`}
                  ...
                  <div className="submitted-exercise-data mt-4">
                    ...
                    {exerciseData.map((exercise) => (
                      <div key={exercise.id} className="exercise-entry">
                        ...
                        <button onClick={handleEdit} className="text-indigo-500 mr-2">
                          Edit
                        </button>
